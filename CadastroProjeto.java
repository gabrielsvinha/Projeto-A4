...
public class CadastroProjeto {
    ...
    public String toString() {
        return String.format("Código: " + this.getCodigo() + " | Cliente: " + this.cliente.getNome() + " | Data de Início: " + this.dataFormatada + " | Descrição: " + this.getDescricao() + " | Valor Total: " + this.getValorTotal());
    }
