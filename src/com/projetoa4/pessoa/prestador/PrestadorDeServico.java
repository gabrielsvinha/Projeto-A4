...
public class PrestadorDeServico extends Pessoa {
    ...
    public String toString() {
        return String.format("Código: " + this.getCodigo() + " | Nome: " + this.getNome()
                ...
                + " | Descrição: " + this.getDescricao() + " | Desconto: " + this.getDesconto());
    }
    
    public PrestadorDeServico() {}
    public PrestadorDeServico(int codigo, String nome, String telefone, String endereco,
            String descricao, double desconto) {
